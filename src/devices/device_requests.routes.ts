...
deviceRequestsRouter.post('/:request_id/split-fulfill', controller.processSplitFulfillment);
deviceRequestsRouter.get('/:request_id/history', controller.getRequestHistory);
